...
namespace Sidub.Platform.Storage.Test.Models.Gremlin
{
    ...
    public class MenuItem : IEntity
    {
        ...
        [EntityRecordRelation<MenuItemType>("Type", EntityRelationshipType.Composition)]
        public EntityReference<MenuItemType> Type { get; set; } = EntityReference<MenuItemType>.Null;
