...
namespace Sidub.Platform.Storage.Test.Models
{
    public class GremlinUserByUsernameQuery : IRecordQuery<GremlinUser>
    {
        ...
        public IFilter GetFilter()
        {
            ...
            builder.Add("UserId", ComparisonOperator.Equals, Username);
